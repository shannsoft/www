app.controller('ServiceController',function($scope,$state,$stateParams,$ionicModal,ionicDatePicker,PaymentService,ServicesService,$localStorage,TicketService,$ionicLoading,$timeout,LocationModel){
    var vm = this;
    vm.reqTktDataObj = {};
    var ipObj1 = {
       ...
       $ionicLoading.show({
        ...
        // console.log(vm.reqTktDataObj);
         if(vm.reqTktDataObj.services.length > 0 && vm.reqTktDataObj.usrVehicle ){
                ...
                vm.modal.hide();
                $ionicLoading.hide();
                vm.openCheckOutModal(response.data);
                // $timeout(function(){
                //     $ionicLoading.hide();
